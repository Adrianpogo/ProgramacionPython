...
print("\nEstudiantes con promedio superior a 6.0:", estudiantes_sobresalientes)
...
print(f"\nLa edad promedio de las personas en {ciudad_filtrada} es: {promedio_edad:.2f}")
...
print(f"\nComentarios negativos: {comentarios_negativos}")
...
print(f"\nTotal de noches reservadas en estancias largas: {total_noches}")
